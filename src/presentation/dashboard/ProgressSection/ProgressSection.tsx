...
import { useUserProgress } from '../../../application/hooks';
import { UserProgressWithContent } from '../../../application/types/database.types';
import styles from '../../_styles/components/dashboard/ProgressSection.module.css';
