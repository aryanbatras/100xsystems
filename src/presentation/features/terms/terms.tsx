/**
 * ## Presentation: Terms of Service Page
 *
 * Static terms of service page displaying user agreements,
 * service descriptions, and legal policies for 100xSystems.
 *
 * @packageDocumentation
 */

import styles from '../../_styles/pages/Terms.module.css';
