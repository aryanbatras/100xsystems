 ...
 * Contains all components, types, and logic for the admin domain.
 *
...
// Source: admin.tsx
// ============================================================
const CustomQuillEditor = dynamic(() => import("./editor.feature").then(mod => ({ default: mod.CustomQuillEditor })), {
  ssr: false,
...
// Source: index.ts
// ============================================================
// All exports from types.ts are merged above
