...
import { PageHeader, Accordion, Alert, SearchInput, TabBar, Pagination, EmptyState, Breadcrumbs, CodeBlock, Timeline, ArticleCard, DifficultyBadge, FeatureCard, StatCard, ComingSoonCard, ModuleCard, FaqItem, ContactInfoItem } from '../components.composite';

const meta = {
  title: 'Composites/All',
  component: PageHeader as React.ComponentType<unknown>,
...
export const PageHeaderStory: Story = { name: 'PageHeader', render: () => <PageHeader title="System Design" subtitle="Master distributed systems" breadcrumbs={[{ label: 'Home' }, { label: 'Roadmaps' }]} meta={[{ label: 'Difficulty', value: 'Advanced' }]} /> };
...
export const EmptyStateStory: Story = { name: 'EmptyState', render: () => <EmptyState icon="📚" title="No items" description="Nothing to show yet." /> };
