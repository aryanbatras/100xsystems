/**
 * ## AI Diagram: Templates
 *
 * Pre-built diagram templates for common diagram types
 * (flowcharts, sequence diagrams, architecture diagrams, etc.).
 * Used as starting points for AI-generated diagrams.
 *
 * @packageDocumentation
 */

import { DiagramTemplate, ExcalidrawElementSkeleton } from './diagram.types';
