 ...
 * ## AI Diagram: Parser
 *
 * Parses AI responses into Excalidraw diagram elements.
 * Handles natural language instructions for diagram generation,
 * element positioning, and layout optimization.
 *
 * @packageDocumentation
 */

import { ExcalidrawElementSkeleton, DiagramRequest, EnhancedChatResponse, DiagramValidationResult } from './diagram.types';
