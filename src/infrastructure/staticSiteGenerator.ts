/**
 * ## Infrastructure: Static Site Generator
 *
 * Core static site generation engine. Builds knowledge graphs,
 * search indexes, and fetches compiled article data for
...
import { 
  ...
  ValidationResult,
  VerificationResult
} from '../application/types/resources.types';
