/**
 * ## Infrastructure: HTML to Delta Converter
 *
 * Parses published HTML back into Quill Delta format.
 * Enables round-trip editing of previously published articles
 * by extracting metadata and reconstructing the editor state.
 *
