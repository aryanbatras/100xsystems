/**
 * ## Infrastructure: Article Updater
 *
 * Handles updating existing published articles — validates
 * eligibility, uploads new content, and manages the update
 * lifecycle on GitHub Pages.
 *
 * @packageDocumentation
 */

import { GitHubPublisher } from './api/githubPublisher';
