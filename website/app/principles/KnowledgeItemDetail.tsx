            ...
            <div className={cn('mx-auto px-6 lg:px-12 py-12 lg:py-16', contentMaxW)}>
              ...
              <div className="flex items-center justify-between mb-10">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-fg-muted font-medium hidden sm:inline">{config.label} / {item.title}</span>
                </div>
              ...
              <div className="mb-8">
                <div className="flex items-center gap-2 mb-3">
                  {item.difficulty && (
                    <span className={cn('text-[10px] font-bold uppercase tracking-wider', difficultyStyles[item.difficulty])}>
                      {item.difficulty}
                    </span>
                  )}
